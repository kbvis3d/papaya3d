...
papaya.ui.Toolbar.FILE_MENU_DATA = {"label": "File", "icons": null,
    "items": [
        ...
        {"label": "Show Volume...", "action": "OpenVolume"},
    ...
    "menus": [
        ...
        {"label": "View", "icons": null,
            "items": [
                ...
                { "label": "Axial Plane", "action": "ShowAxialPlane", "type": "checkbox", "method": "isShowingAxialPlane" },
                { "label": "Coronal Plane", "action": "ShowCoronalPlane", "type": "checkbox", "method": "isShowingCoronalPlane" },
                { "label": "Sagittal Plane", "action": "ShowSagittalPlane", "type": "checkbox", "method": "isShowingSagittalPlane" }
            ]
        },
            ...
            if (!papayaLoadableImages[ctr].hide) {
                if (papayaLoadableImages[ctr].surface) {
                    ...
                    if (!this.menuContains(items, menuItemName)) {
                        items.splice(2, 0, {"label": menuItemName, "action": "OpenVolume-" + papayaLoadableImages[ctr].name});
                    }
                } else {
...
papaya.ui.Toolbar.prototype.doAction = function (action, file, keepopen) {
    ...
    if (action) {
        if (action.startsWith("ImageButton")) {
        ...
        } else if (action.startsWith("OpenVolume-")) {
            imageName = action.substring(action.indexOf("-") + 1);
            this.viewer.load3dVolume(imageName);
            ...
            this.viewer.volumeView.changeColorTable(this.viewer, colorTableName);
            ...
            dialog = new papaya.ui.Dialog(this.container, "Surface Preferences", papaya.ui.Toolbar.PREFERENCES_SURFACE_DATA,
                ...
                papaya.utilities.ObjectUtils.bind(this,
                    function() {
                        this.viewer.updateScreenSliceTransforms();
                        this.viewer.volumeView.updatePreferences();
                        this.viewer.drawViewer(false, true);
                    }
                )
            );
            ...
            this.viewer.drawViewer();
            this.closeAllMenus();
        } else if (action.startsWith("ShowAxialPlane")) {
            if (this.container.preferences.showAxialPlane === "Yes") {
                this.container.preferences.updatePreference("showAxialPlane", "No");
            } else {
                this.container.preferences.updatePreference("showAxialPlane", "Yes");
                this.container.preferences.updatePreference("showCoronalPlane", "No");
                this.container.preferences.updatePreference("showSagittalPlane", "No");
            }
            this.viewer.drawViewer();
            this.closeAllMenus();
        } else if (action.startsWith("ShowCoronalPlane")) {
            if (this.container.preferences.showCoronalPlane === "Yes") {
                this.container.preferences.updatePreference("showCoronalPlane", "No");
            } else {
                this.container.preferences.updatePreference("showAxialPlane", "No");
                this.container.preferences.updatePreference("showCoronalPlane", "Yes");
                this.container.preferences.updatePreference("showSagittalPlane", "No");
            }
            this.viewer.drawViewer();
            this.closeAllMenus();
        } else if (action.startsWith("ShowSagittalPlane")) {
            if (this.container.preferences.showSagittalPlane === "Yes") {
                this.container.preferences.updatePreference("showSagittalPlane", "No");
            } else {
                this.container.preferences.updatePreference("showAxialPlane", "No");
                this.container.preferences.updatePreference("showCoronalPlane", "No");
                this.container.preferences.updatePreference("showSagittalPlane", "Yes");
            }
            this.viewer.drawViewer();
            this.closeAllMenus();
            ...
            this.viewer.volumeView.showSurfacePlanes = !this.viewer.volumeView.showSurfacePlanes;
            this.viewer.volumeView.updateVolumeView();
            ...
            this.viewer.volumeView.showSurfaceCrosshairs = !this.viewer.volumeView.showSurfaceCrosshairs;
            this.viewer.volumeView.updateActivePlanes();
