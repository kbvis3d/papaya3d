...
papaya.viewer.Preferences = papaya.viewer.Preferences || function () {
    ...
    this.showAxialPlane = "No";
    this.showCoronalPlane = "No";
    this.showSagittalPlane = "No";
    this.showVolume = "Yes";
};
...
papaya.viewer.Preferences.ALL_PREFS = ["showAxialPlane", "showCoronalPlane", "showSagittalPlane", "showCrosshairs", "atlasLocks", "showOrientation", "scrollBehavior",
